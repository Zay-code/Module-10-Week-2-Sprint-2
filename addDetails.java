...
//			Connection con = DriverManager.getConnection(ur);
			...
			String query = "INSERT INTO tblStudents VALUES ('"+sName+"', '"+sSurname+"', '"+sGrade+"', '"+sDOB+"',  '"+ pContact+"')";
			Statement Stmt = con.createStatement();
			int rs = Stmt.executeUpdate(query);
			Statement st = con.createStatement();
                        String qry = "INSERT INTO tblParents VALUES ('"+pName+"', '"+pSurname+"', '"+sName+"', '"+pContact+"',  '"+ Address+"')";
			Statement St = con.createStatement();
