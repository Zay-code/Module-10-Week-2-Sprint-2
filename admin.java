...
public class Admin extends javax.swing.JFrame {
    ...
    private void btnDeleteLearnerActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        try {
            ...
            String q = "SELECT * FROM tblLearner WHERE ParentContact ='" + Deleted + "'";
            ResultSet rs = st.executeQuery(q);
            String answer = JOptionPane.showInputDialog("Are you sure you want to Delete this record YES/NO");
            if (answer.equalsIgnoreCase("Yes")) {
                q = "DELETE FROM tblLearner WHERE ParentContact='" + Deleted + "'";
                st.executeUpdate(q);
    ...
    private void btnDeleteParentActionPerformed(java.awt.event.ActionEvent evt) {                                                
        try {
            Class.forName("net.ucanaccess.jdbc.UcanaccessDriver");
    ...
    private void btnSearchLearnerActionPerformed(java.awt.event.ActionEvent evt) {                                                 
      try {
			Class.forName("net.ucanaccess.jdbc.UcanaccessDriver");
		   ...
		   String q="SELECT * FROM tblStudent WHERE LearnerName LIKE'%"+Content+"%'";
		   ResultSet rs= st.executeQuery(q);
		con.close();
		   }catch(Exception e){
				System.out.println(e);
    ...
    private void btnSearchParentActionPerformed(java.awt.event.ActionEvent evt) {                                                
   try {
			Class.forName("net.ucanaccess.jdbc.UcanaccessDriver");
		   ...
		   String q="SELECT * FROM tblParent WHERE ParentName LIKE'%"+Content+"%'";
		   ResultSet rs= st.executeQuery(q);
		con.close();
		   }catch(Exception e){
				System.out.println(e);
    ...
    private void btnSearchTeacherActionPerformed(java.awt.event.ActionEvent evt) {                                                 
        try {
